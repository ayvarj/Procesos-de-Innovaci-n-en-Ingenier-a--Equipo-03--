...
Somos el equipo 03 del curso de Procesos de Innovación en Ingeniería 2026 - II, conformados por los estudiantes de la carrera de Ingeniería Biomédica.

Nuestro objetivo es aplicar la metodología de innovación para generar soluciones con impacto social.

---

## 🌍 Objetivos de Desarrollo Sostenible (ODS)

Nuestro proyecto se alinea directamente con los siguientes Objetivos de Desarrollo Sostenible de la ONU:
...
| <img width="80" height="80" alt="WhatsApp Image 2026-08-31 at 10 35 56 PM (1)" src="https://github.com/user-attachments/assets/77974fa6-a4b2-4cdb-a7b1-3b0829a9f2a8" > | **Isaid Villegas** | *investigador* | *biomecatronico* |
---

## 📝 Resumen

Este es el README que resume quiénes somos, qué nos motiva y en qué queremos enfocar nuestro trabajo durante el curso.
